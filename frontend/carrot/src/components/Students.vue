<template>
  <Breadcrumb :elements="['Students', ]"></Breadcrumb>

  <div
      class="flex items-start justify-between flex-wrap gap-4 pb-4 bg-white dark:bg-gray-800">
    <div>
    ...
    <div class="flex items-start flex-wrap gap-4">
      ...
      <button
          class="text-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Add student
      </button>
    </div>
  </div>
